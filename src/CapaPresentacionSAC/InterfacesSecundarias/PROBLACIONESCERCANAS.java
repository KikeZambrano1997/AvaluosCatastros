 ...
 * @author Usuario
 */
public class PROBLACIONESCERCANAS extends javax.swing.JFrame {
    DefaultTableModel TablaPoblaciones;
    capadatossac.ConexionTablas con = new capadatossac.ConexionTablas();
    /**
     * Creates new form PROBLACIONESCERCANAS
     */
    public PROBLACIONESCERCANAS() {
        TablaPoblaciones = new DefaultTableModel(null, getColumnasPoblaciones());
        setFilasPoblaciones();
        initComponents();
        setResizable(false);
        setLocationRelativeTo(this);
        setTitle("Poblaciones Cercanas");
        letras(poblacion);
        numeros(id);
        Decimales(indicador);
    }
    
    private String [] getColumnasPoblaciones(){
        String columna1[] = new String[]{"ID", "POBLACIONES CERCANAS", "INDICADOR"};
        return columna1;
    }
    
    private void setFilasPoblaciones(){
        try{

            String sql = "SELECT id, poblacionesCercanas, indicador FROM PoblCercanas"; 
            ...
            while(res.next()){
                ...
                TablaPoblaciones.addRow(datos);
            }

        }
        catch (SQLException e){
            Logger.getLogger(PROBLACIONESCERCANAS.class.getName()).log(Level.SEVERE, null, e);
        }          
    }

    private void LimpiarTabla(){
       for (int i = 0; i < TablaPoblaciones.getRowCount(); i++) {
           TablaPoblaciones.removeRow(i);
           i-=1;
       }
   }
    ...
    private void initComponents() {
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "POBLACIONES CERCANAS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
        jPanel7.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        jTable1.setModel(TablaPoblaciones);
    ...
    private void guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardar1ActionPerformed
        ...
        a.ejecutar("insert into PoblCercanas values("+Integer.parseInt(id.getText())+",'"+
            poblacion.getText()+"',"+Float.parseFloat(indicador.getText())+")");
        id.setText("");
        poblacion.setText("");
        indicador.setText("");
        LimpiarTabla();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PROBLACIONESCERCANAS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PROBLACIONESCERCANAS().setVisible(true);
            }
        });
    }
