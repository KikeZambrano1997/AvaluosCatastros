 ...
 * @author Usuario
 */
public class DRENAJE extends javax.swing.JFrame {
    DefaultTableModel TablaDrenaje;
    ...
    private String [] getColumnasDrenaje(){
        String columna1[] = new String[]{"ID", "DRENAJE", "INDICADOR"};
        return columna1;
    }
    
    private void setFilasDrenaje(){
        try{

            String sql = "SELECT id, drenaje, indicador FROM Drenaje"; 
            ...
            while(res.next()){
                ...
                TablaDrenaje.addRow(datos);
            }

        }
        catch (SQLException e){
            Logger.getLogger(DRENAJE.class.getName()).log(Level.SEVERE, null, e);
        }          
    }

    private void LimpiarTabla(){
       for (int i = 0; i < TablaDrenaje.getRowCount(); i++) {
           TablaDrenaje.removeRow(i);
           i-=1;
       }
   }
    ...
    private void initComponents() {
        ...
        drenaje = new javax.swing.JTextField();
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DRENAJE", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        jPanel7.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        drenaje.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                drenajeActionPerformed(evt);
            }
        });

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel1.setText("DRENAJE:");
        ...
        jPanel7Layout.setVerticalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(drenaje, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void drenajeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_drenajeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_drenajeActionPerformed
    ...
    private void guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardar1ActionPerformed
        ...
        a.ejecutar("insert into AccesoyVias values("+Integer.parseInt(id.getText())+",'"+
            drenaje.getText()+"',"+Float.parseFloat(indicador.getText())+")");
        id.setText("");
        drenaje.setText("");
        indicador.setText("");
        LimpiarTabla();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DRENAJE().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField drenaje;
