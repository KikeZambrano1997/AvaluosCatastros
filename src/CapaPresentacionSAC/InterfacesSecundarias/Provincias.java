...
public class Provincias extends javax.swing.JFrame {
    DefaultTableModel TablaProvincias;
     ...
     */
    public Provincias() {
        TablaProvincias = new DefaultTableModel(null, getColumnasProvincias());
        setFilasProvincias();
    ...
    private String [] getColumnasProvincias(){
        String columna1[] = new String[]{"ID", "CÓDIGO", "PROVINCIAS"};
        return columna1;
    }
    
    private void setFilasProvincias(){
        try{

            String sql = "SELECT id, codigo, nombre FROM Provincia order by id"; 
            ...
            while(res.next()){
                ...
                TablaProvincias.addRow(datos);
            }

        }
        catch (SQLException e){
            Logger.getLogger(Provincias.class.getName()).log(Level.SEVERE, null, e);
        }          
    }
    
    private void LimpiarTabla(){
       for (int i = 0; i < TablaProvincias.getRowCount(); i++) {
           TablaProvincias.removeRow(i);
           i-=1;
       }
   }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "PROVINCIAS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 18))); // NOI18N
        ...
        jTable1.setModel(TablaProvincias);
    ...
    private void guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardar1ActionPerformed
        ...
        a.ejecutar("insert into Provincia values("+Integer.parseInt(id.getText())+",'"+
